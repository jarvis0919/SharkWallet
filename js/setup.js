...
ipcRenderer.on("editaccountstate", (event, state) => {
    document.getElementById("editaccountstate").innerHTML = state;
...
ipcRenderer.on("addtokenstate", (event, state) => {
    document.getElementById("addtokenstate").innerHTML = state;
})
